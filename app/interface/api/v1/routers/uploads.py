...
@router.post("/song-thumbnail", response_model=APIResponse)
async def upload_song_thumbnail(file: UploadFile = File(...)):
    """
    Upload a song thumbnail to S3.
    ...
    # Subir a S3
    url = s3_service.upload_song_thumbnail(
        file_content=content,
