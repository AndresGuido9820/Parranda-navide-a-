...
from app.domain.entities.novena_progress import UserNovenaProgress as DomainNovenaProgress
from ...models.novena import NovenaDay as NovenaDayORM, UserNovenaProgress as UserNovenaProgressORM
...
class NovenaRepository:
    ...
    def get_user_progress(self, user_id: str) -> List[DomainNovenaProgress]:
        ...
        stmt = select(UserNovenaProgressORM).where(UserNovenaProgressORM.user_id == user_id)
    ...
    def _to_domain_progress(self, progress_orm: UserNovenaProgressORM) -> DomainNovenaProgress:
        """Convert ORM to domain entity."""
